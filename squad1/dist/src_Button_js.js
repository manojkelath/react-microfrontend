(self["webpackChunkremote1"] = self["webpackChunkremote1"] || []).push([["src_Button_js"],{
...
const Button = () => {
  ...
  return /*#__PURE__*/libs_react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    onClick: handleClick
